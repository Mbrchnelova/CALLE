...
for line in lines:
	...
	if START_READING:
		...
		ts_radyn.append(float(line[1]))
		ds_radyn.append(float(line[2])*1.6726219e-24)
...
MHDoutfile = open("Interpolated_val3c_print.CFmesh", "w")
